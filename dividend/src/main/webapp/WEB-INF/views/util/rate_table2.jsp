...
<script type="text/javascript" charset="utf-8">
            ...
            function input_updown(rate_val)   {
                ...
                new_val=parseFloat(loan_value)+rate_val;
                console.log(loan_value);
                console.log(new_val);
                ...
                new_val_comma=addComma(new_val);
            ...
            function but()  {
                ...
                {
                    input_loan=loan.value
                    invest_loan=input_loan
                    $("#loan").val(addComma(loan.value))
                	//이자율  리스트 생성
                    compare_html="<p><b>※ 투자기간별 금액 (단위:원)</b></p>"
                	compare_html=compare_html+'<table class="rate_table"><tr><td>투자기간(년)</td><td>투자금(원)</td><td>평가금액(원)</td><td>수익률</td>';
                	...
                	for (var i=1;i<=months.value;i=i+1)	{
                            ...
                            input_loan=Math.round(return_value)
                	} 
            ...
            <fieldset style="display: block;margin-left: 2px;margin-right: 2px;padding-top: 0.35em;padding-bottom: 0.625em;padding-left: 0.75em;padding-right: 0.75em;border: 2px groove; width:60%;">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <input type="text" style="text-align:right;" id="loan" class="cal_inp_txt" onchange="loan_change()">&nbsp;&nbsp;<span style="font-family: BMHANNAPro;font-size: 20px;">원</span>&nbsp;&nbsp;
                            <input type="button" value="-백만원" class="btn_cal" onclick="input_updown(-1000000)">
                            <input type="button" value="+백만원" class="btn_cal" onclick="input_updown(1000000)">
                        </li>
                        <li>
                            <label class="cal_label" for="rate">수익률&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                            <input type="number" style="text-align:right;border: 1px solid gray;" id="rate">&nbsp;&nbsp;<span style="font-size: 20px;">%&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
